...
export default function Home() {
  return (
    <>
      <div className="w-full max-w-6xl mx-auto font-quicksand px-5">
        <div className="my-20 ">
          <div className="flex flex-col md:flex-row gap-7 items-center justify-center md:justify-between duration-300">
            <div className="text-cDark ">
              <h1 className="text-[54px] leading-tight">
                ...
                <span className="text-cBlue font-bold font-bungee"> SELF DISCOVERY</span> and{" "}
                <span className="text-cBlue font-bold font-bungee">EXPRESSION</span>
              </h1>
      ...
      <div className="py-20 px-5 font-quicksand">
        <h1 className="text-[34px] text-center font-bold text-cDark leading-tight mb-10 font-bungee">
          Frequently Asked Questions
        </h1>
        <FAQs />
      </div>
      <div className="border-t py-20 px-5 font-quicksand">
        <h1 className="text-[34px] text-center text-cBlue font-bold leading-tight mb-10 font-bungee">
